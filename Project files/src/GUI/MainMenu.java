...
public class MainMenu implements Component{
	...
	public void draw() {
		 ...
		 */
		JLabel titleLabel = new JLabel("Rental Property Management Application");
		titleLabel.setForeground(new Color(255, 255, 255));
		titleLabel.setFont(new Font("SansSerif", Font.BOLD, 20));
		titleLabel.setBounds(50, 10, 400, 50);
		...
		dbUsername.setBounds(50, 71, 144, 21); //31, 71
		...
		dbPassword.setBounds(258, 71, 170, 21); // 258, 71
		...
		sqlUsername.setBounds(50, 98, 170, 21); //29, 98
		...
		sqlPassword.setBounds(258, 98, 170, 21); //240, 98
